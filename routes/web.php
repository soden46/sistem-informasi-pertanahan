...
Route::middleware(['auth', 'role:kaspem'])->group(function () {
    ...
    Route::controller(DataTanahController::class)->group(function () {
        ...
        Route::post('/data-tanah/{no_kk}', 'update')->name('data-tanah/update')->middleware('auth');
        Route::delete('/data-tanah/{no_kk}', 'destroy')->name('data-tanah')->middleware('auth');
    });
...
Route::middleware(['auth', 'role:masyarakat'])->group(function () {
    Route::controller(KadesController::class)->group(function () {
        Route::get('/kades', 'index')->name('masyarakat');
    });

    Route::controller(KadesDataTanahController::class)->group(function () {
        Route::get('/data-tanah', 'index')->name('data-tanah')->middleware('auth');
        Route::post('/data-tanah/store', 'store')->name('data-tanah/store')->middleware('auth');
        Route::post('/data-tanah/{no_kk}', 'update')->name('data-tanah/update')->middleware('auth');
        Route::delete('/data-tanah/{no_kk}', 'destroy')->name('data-tanah')->middleware('auth');
