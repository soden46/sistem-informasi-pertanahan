...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="card" style="width: 100%; height: 100%; background-color: white; padding: 20px">
        ...
        <div>
            <div class="d-flex">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cretaeDataPersil" style="margin-right: 15px">Tambah Data Persil</button>
            ...
            <!-- Modal create-->
            <div class="modal fade" id="cretaeDataMasyarakat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="cretaeDataPersilLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="cretaeDataPersilLabel">Tambah Data Keluarga</h1>
