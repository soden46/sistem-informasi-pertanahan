                        ...
                        <form action="/permohonan-informasi/save" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="id_pemohon" id="id_pemohon" class="form-control @error('id_pemohon') is-invalid @enderror" required value="{{ old('id_pemohon') }}" autocomplete="off" placeholder="Input ID Pemohon">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jenis" id="jenis" class="form-control @error('jenis') is-invalid @enderror" required value="{{ old('jenis') }}" autocomplete="off" placeholder="Input Jenis Permohonan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="informasi" id="informasi" class="form-control @error('informasi') is-invalid @enderror" required value="{{ old('informasi') }}" autocomplete="off" placeholder="Input Informasi Permohonan">
            ...
            <table class="table" style="text-align: left; color: black">
                ...
                <tr style="width: 100%">
                    ...
                    <td style="text-align: center;  ">
                        <a href="{{route('permohonan-informasi/pdflurah',$item->id_pemohon) }}" class="btn btn-success" target="_blank">Lurah</a>
                        <a href="{{route('permohonan-informasi/pdf',$item->id_pemohon) }}" class="btn btn-success" target="_blank">Staff</a>
                    </td>
                </tr>
